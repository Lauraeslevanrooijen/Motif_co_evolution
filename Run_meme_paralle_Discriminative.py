...
def meme(protein_pairs):
    with cd(args.inputdirectory+'/'+protein_pairs):
        cmd ='psp-gen -pos target.fa -neg control.fa -protein -minw 6 -maxw 20 -maxrange -triples >prot.psp'
        cmd2 = 'meme target.fa -protein -oc . -nostatus -time 17945 -mod zoops -p 2 -nmotifs 10 -minw 6 -maxw 50 -objfun classic -markov_order 0 -psp prot.psp'
